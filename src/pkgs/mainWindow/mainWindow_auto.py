...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/tools/icons/dbLib-new.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/tools/icons/dbLib-open.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionOpenDbLib.setIcon(icon2)
        self.actionDeleteDbLib = QAction(mainWindow)
        self.actionDeleteDbLib.setObjectName(u"actionDeleteDbLib")
        icon3 = QIcon()
        icon3.addFile(u":/tools/icons/dbLib-delete.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionDeleteDbLib.setIcon(icon3)
        self.actionEditDbLib = QAction(mainWindow)
        self.actionEditDbLib.setObjectName(u"actionEditDbLib")
        icon4 = QIcon()
        icon4.addFile(u":/tools/icons/dbLib-edit.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionEditDbLib.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/tools/icons/delete.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.libDelTbtn.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/tools/icons/edit.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.libEditTbtn.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/tools/icons/add.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.libAddTbtn.setIcon(icon7)
        ...
        self.compDelTbtn.setIcon(icon5)
        ...
        self.compEditTbtn.setIcon(icon6)
        ...
        self.compAddTbtn.setIcon(icon7)
        ...
        self.menuDB_Library.addAction(self.actionDeleteDbLib)
        ...
        self.toolBar.addAction(self.actionDeleteDbLib)
...
#endif // QT_CONFIG(tooltip)
        self.actionDeleteDbLib.setText(QCoreApplication.translate("mainWindow", u"Delete", None))
#if QT_CONFIG(tooltip)
        self.actionDeleteDbLib.setToolTip(QCoreApplication.translate("mainWindow", u"Delete the DB Library", None))
#endif // QT_CONFIG(tooltip)
